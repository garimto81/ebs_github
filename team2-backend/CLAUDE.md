...
| **3-앱 아키텍처** | `specs/back-office/BO-01-overview.md` |
...
| **로그/감사 기록** | `specs/impl/IMPL-07-logging.md` + `BO-03-operations.md` §1 |
...
| 파일 | 줄 | 목적 | 선행 |
|------|----|-----|------|
| `specs/back-office/PRD-EBS_BackOffice.md` | 286 | 기능 채택/제거/EBS 고유 추가 결정 | `BS-00` |
| `specs/back-office/BO-01-overview.md` | 123 | 3-앱 아키텍처·데이터 흐름·기술 스택 | PRD |
| `specs/back-office/BO-02-sync-protocol.md` | 275 | Lobby↔BO↔CC 동기화·WSOP 폴링·Circuit Breaker | BO-01 + API-01 Part II/API-05 |
| `specs/back-office/BO-03-operations.md` | 332 | 감사 로그·리포트·복구 시나리오 | BO-01 + DATA-04 |
...
| `specs/impl/IMPL-10-nfr.md` | 418 | NFR: 신뢰성/동시성/캐시/타임아웃/감사/확장성/보안 **필독** | BO-01 + contracts/ |
...
| 앱 아키텍처 용어 | `../contracts/specs/BS-00-definitions.md` | BO-01, IMPL-01~05 |
