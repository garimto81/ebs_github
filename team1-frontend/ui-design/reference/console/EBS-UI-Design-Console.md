...
> <img src="images/web_screenshots/ggpoker-gto-broadcast.gif" alt="GGPoker + GTO Wizard — 포커 방송 오버레이 (Glassmorphism + 네온 강조)" style="max-width: 960px;">
>
> *GGPoker 방송 오버레이: Glassmorphism 카드 UI, 네온/글로우 이벤트 강조, Bold 타이포 핵심 수치 강조*

> <img src="images/web_screenshots/ggpoker-gto-thumbnail.png" alt="GGPoker GTO Wizard — 실시간 분석 오버레이 썸네일" style="max-width: 960px;">
>
> *GTO Wizard 실시간 분석 오버레이: 확률/Equity 표시, 상태별 동적 UI 전환*

> <img src="images/web_screenshots/wsop-paradise-2025-rfid-broadcast.png" alt="WSOP Paradise 2025 — RFID 기반 방송 오버레이 (올인 상황)" style="max-width: 960px;">
>
...
> <img src="images/mockups/v3/ebs-console-main-v4.png" alt="EBS Console 메인 레이아웃 White Minimal 목업 — Swiss International 스타일" style="max-width: 960px;">
> [ebs-console-main-v4.html](images/mockups/v3/ebs-console-main-v4.html)
>
> <img src="images/annotated/ebs-main-window.png" alt="EBS Console 메인 윈도우 Annotation — Menu Bar, Preview, Info Bar 요소 매핑" style="max-width: 960px;">
>
...
> <img src="images/annotated/ebs-tabbar-outputs.png" alt="Outputs Tab Bar" style="max-width: 960px;">

Outputs 탭은 방송 출력 파이프라인을 구성한다. 3-Column 그리드 내에 **Resolution**, **Live Pipeline**, **Output Mode** 서브그룹을 배치한다.

##### 1. 레이아웃

> <img src="images/mockups/v3/ebs-console-outputs.png" alt="Outputs 탭 레이아웃" style="max-width: 960px;">
>
> *Outputs 탭 — 전폭, 가변 높이, 3-Column 그리드: Resolution | Live Pipeline | Output Mode*
> [ebs-console-outputs.html](images/mockups/v3/ebs-console-outputs.html)

##### 2. 요소 매핑

> <img src="images/annotated/ebs-outputs-tab.png" alt="Outputs 탭 요소 매핑" style="max-width: 960px;">
>
...
> <img src="images/mockups/v5/ebs-overlay-vertical-toggle.png" alt="9:16 Vertical Mode Toggle — 16:9 Landscape vs 9:16 Vertical side-by-side" style="max-width: 960px;">
> [ebs-overlay-vertical-toggle.html](images/mockups/v5/ebs-overlay-vertical-toggle.html)
...
> <img src="images/annotated/ebs-tabbar-gfx.png" alt="GFX Tab Bar" style="max-width: 960px;">
...
> <img src="images/mockups/v3/ebs-console-gfx.png" alt="GFX 탭 레이아웃" style="max-width: 960px;">
>
> *GFX 탭 — 전폭, 가변 높이, 3-Column 그리드: Layout | Card & Player | Animation*
> [ebs-console-gfx.html](images/mockups/v3/ebs-console-gfx.html)

##### 2. 요소 매핑

> <img src="images/annotated/ebs-gfx-tab.png" alt="GFX 탭 요소 매핑" style="max-width: 960px;">
>
> *번호 = annotation 박스. 각 요소의 상세는 아래 테이블 참조.*
...
> <img src="images/mockups/v5/ebs-gfx-board-position.png" alt="Board Position 4종 — Left / Centre / Right / Top" style="max-width: 960px;">
> [ebs-gfx-board-position.html](images/mockups/v5/ebs-gfx-board-position.html)
...
> <img src="images/mockups/v5/ebs-gfx-leaderboard-position.png" alt="Leaderboard Position 4종 — Off / Centre / Left / Right" style="max-width: 960px;">
> [ebs-gfx-leaderboard-position.html](images/mockups/v5/ebs-gfx-leaderboard-position.html)
...
> <img src="images/mockups/v5/ebs-gfx-player-layout.png" alt="Player Layout 3종 — Horizontal / Vert-Bot-Spill / Vert-Top-Fit" style="max-width: 960px;">
> [ebs-gfx-player-layout.html](images/mockups/v5/ebs-gfx-player-layout.html)
...
> <img src="images/mockups/v5/ebs-gfx-indent-action.png" alt="Indent Action Player — 일반 상태 vs Indent 활성 (P3 보드 방향 이동)" style="max-width: 960px;">
> [ebs-gfx-indent-action.html](images/mockups/v5/ebs-gfx-indent-action.html)
...
> <img src="images/annotated/ebs-tabbar-display.png" alt="Display Tab Bar" style="max-width: 960px;">

Display 탭은 수치 표시 형식을 영역별로 세밀하게 제어한다. PokerGFX GFX 3 탭의 Display 설정을 계승한다. 3개 서브그룹: **Blinds → Precision → Mode**.

##### 1. 레이아웃

> <img src="images/mockups/v3/ebs-console-display.png" alt="Display 탭 레이아웃" style="max-width: 960px;">
>
> *Display 탭 — 전폭, 가변 높이, 3-Column 그리드: Blinds | Precision | Mode*
> [ebs-console-display.html](images/mockups/v3/ebs-console-display.html)

##### 2. 요소 매핑

> <img src="images/annotated/ebs-display-tab.png" alt="Display 탭 요소 매핑" style="max-width: 960px;">
>
> *번호 = annotation 박스. 각 요소의 상세는 아래 테이블 참조.*
...
> <img src="images/annotated/ebs-tabbar-rules.png" alt="Rules Tab Bar" style="max-width: 960px;">
...
> <img src="images/mockups/v3/ebs-console-rules.png" alt="Rules 탭 레이아웃" style="max-width: 960px;">
>
> *Rules 탭 — 전폭, 가변 높이, 2-Column: Game Rules | Player Display*
> [ebs-console-rules.html](images/mockups/v3/ebs-console-rules.html)

##### 2. 요소 매핑

> <img src="images/annotated/ebs-rules-tab.png" alt="Rules 탭 요소 매핑" style="max-width: 960px;">
>
> *번호 = annotation 박스. 각 요소의 상세는 아래 테이블 참조.*
...
> <img src="images/annotated/ebs-tabbar-stats.png" width="720" alt="Stats 탭바">
...
> <img src="images/mockups/v3/ebs-console-stats.png" width="720" alt="Console Stats 탭 레이아웃">
> <small>Console — Stats 탭 레이아웃</small>
> [ebs-console-stats.html](images/mockups/v3/ebs-console-stats.html)

> *Stats 탭 — 전폭, 가변 높이, 2-Column: Equity & Statistics | Leaderboard & Strip*

##### 2. 요소 매핑

> <img src="images/annotated/ebs-stats-tab.png" width="720" alt="Stats 탭 요소 매핑">
>
> *번호 = annotation 박스. 각 요소의 상세는 아래 테이블 참조.*
...
> <img src="images/mockups/v5/ebs-stats-equity-outs.png" alt="Equity Bar + Show Outs + Outs Position 통합 다이어그램" style="max-width: 960px;">
> [ebs-stats-equity-outs.html](images/mockups/v5/ebs-stats-equity-outs.html)
...
> <img src="images/mockups/v5/ebs-stats-score-strip.png" alt="Score Strip 화면 위치 — Player Graphic 하단, 전폭 배치" style="max-width: 960px;">
> [ebs-stats-score-strip.html](images/mockups/v5/ebs-stats-score-strip.html)
...
> <img src="images/mockups/v5/ebs-stats-leaderboard-columns.png" alt="Leaderboard 컬럼 구성 — 기본 3컬럼 vs KO Rank + Chipcount % 5컬럼" style="max-width: 960px;">
> [ebs-stats-leaderboard-columns.html](images/mockups/v5/ebs-stats-leaderboard-columns.html)
