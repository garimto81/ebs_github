...
_$EbsEventImpl _$$EbsEventImplFromJson(Map<String, dynamic> json) =>
    _$EbsEventImpl(
      ...
      eventNo: (json['event_no'] as num?)?.toInt() ?? 0,
      eventName: json['event_name'] as String,
      buyIn: (json['buy_in'] as num?)?.toInt(),
      displayBuyIn: json['display_buy_in'] as String?,
      gameType: (json['game_type'] as num?)?.toInt() ?? 0,
      betStructure: (json['bet_structure'] as num?)?.toInt() ?? 0,
      eventGameType: (json['event_game_type'] as num?)?.toInt() ?? 0,
      gameMode: json['game_mode'] as String? ?? 'single',
      ...
      tableSize: (json['table_size'] as num?)?.toInt() ?? 9,
