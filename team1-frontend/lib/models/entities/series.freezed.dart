...
class _$SeriesImpl implements _Series {
  const _$SeriesImpl(
      ...
      @JsonKey(name: 'is_displayed') required this.isDisplayed,
      @JsonKey(name: 'is_demo') required this.isDemo,
...
abstract class _Series implements Series {
  const factory _Series(
          ...
          @JsonKey(name: 'is_displayed') required final bool isDisplayed,
          @JsonKey(name: 'is_demo') required final bool isDemo,
