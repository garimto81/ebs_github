...
_$EbsTableImpl _$$EbsTableImplFromJson(Map<String, dynamic> json) =>
    _$EbsTableImpl(
      ...
      anteType: (json['ante_type'] as num?)?.toInt() ?? 0,
      anteAmount: (json['ante_amount'] as num?)?.toInt() ?? 0,
      rfidReaderId: (json['rfid_reader_id'] as num?)?.toInt(),
      deckRegistered: json['deck_registered'] as bool? ?? false,
      ...
      isBreakingTable: json['is_breaking_table'] as bool? ?? false,
