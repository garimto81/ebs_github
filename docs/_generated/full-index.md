...
| `docs/2. Development/2.1 Frontend/Backlog/B-092-lobby-visual-screenshots-cascade-2026-05-05.md` | "Lobby visual/screenshots — 신 디자인 7장 cascade + 본문 문서 정합 갱신" | conductor | - | - |
...
| `docs/2. Development/2.1 Frontend/Lobby/Backlog/NOTIFY-Conductor-ci-drift-2026-05-08.md` | NOTIFY-Conductor — PR #176 CI 차단 main drift 위임 | stream:S2 (Lobby) → conductor | notify | - |
...
| `docs/2. Development/2.1 Frontend/Lobby/Backlog/NOTIFY-S2-pr176-ci-failure-2026-05-08.md` | NOTIFY-S2 — PR #176 CI FAILURE (3 checks) — owner fix 필요 | conductor (audit trail) | notify | - |
...
| `docs/2. Development/2.2 Backend/Database/State_Machines.md` | State Machines | team2 | internal | DATA-03 |
| `docs/2. Development/2.2 Backend/Engineering/Build_and_Deploy.md` | Build and Deploy | team2 | internal | IMPL-09 |
...
| `docs/2. Development/2.2 Backend/Engineering/Sandbox_Tournament_Generator.md` | Sandbox Tournament Generator | team2 | internal | null |
...
| `docs/2. Development/2.3 Game Engine/Backlog/NOTIFY-S8-pr180-ci-failure-2026-05-08.md` | NOTIFY-S8 — PR #180 CI FAILURE (5 checks) — owner fix 필요 | conductor (audit trail) | notify | - |
...
| `docs/2. Development/2.4 Command Center/Backlog/NOTIFY-S3-pr171-ci-failure-2026-05-08.md` | NOTIFY-S3 — PR #171 CI FAILURE (4 checks) — owner fix 필요 | conductor (audit trail) | notify | - |
...
| `docs/2. Development/2.4 Command Center/Command_Center_UI/Multi_Table_Operations.md` | Multi Table Operations | team4 | internal | BS-05-10 |
| `docs/2. Development/2.4 Command Center/Command_Center_UI/Overview.md` | Overview | team4 | internal | BS-05-00 |
| `docs/2. Development/2.4 Command Center/Command_Center_UI/Player_Edit_Modal.md` | Player Edit Modal | team4 | internal | BS-05-09 |
| `docs/2. Development/2.4 Command Center/Command_Center_UI/Seat_Management.md` | Seat Management | team4 | internal | BS-05-03 |
...
| `docs/2. Development/2.4 Command Center/Overlay/Security_Delay.md` | Security Delay | team4 | internal | BS-07-07 |
| `docs/2. Development/2.4 Command Center/Overlay/Sequences.md` | Sequences | team4 | internal | BS-07-08 |
| `docs/2. Development/2.4 Command Center/Overlay/Skin_Loading.md` | Skin Loading | team4 | internal | BS-07-03 |
| `docs/2. Development/2.4 Command Center/RFID_Cards/Card_Detection.md` | Card Detection | team4 | internal | BS-04-02 |
| `docs/2. Development/2.4 Command Center/RFID_Cards/Deck_Registration.md` | Deck Registration | team4 | internal | BS-04-01 |
...
| `docs/4. Operations/Conductor_Backlog/IMPL-001-team-backlog-retag.md` | "구현: 4팀 Backlog 3-Type retag + archive 정리" | each_team  # 각 팀 세션에서 자기 Backlog 에 대해 실행 | - | - |
...
| `docs/4. Operations/Conductor_Backlog/IMPL-006-websocket-ack-reject-publishers.md` | "구현: WebSocket Ack/Reject 6 이벤트 publisher (SG-020)" | team2  # publisher 주체 (team3 협업 불필요 — spec §1.1.1 SSOT 분석 결과 BO publisher 단독) | - | - |
...
| `docs/4. Operations/Conductor_Backlog/SG-008-api-d3-bulk-documentation.md` | "Spec Drift: Backend HTTP D3 — 89 code-only endpoints 3분류 (기획이 진실)" | conductor  # 1차 분류. (c) 코드 삭제는 team2 세션 집행 | - | - |
...
| `docs/4. Operations/Conductor_Backlog/SG-008-b13-settings-code-only-cleanup.md` | "Settings Drift: 30 code-only provider fields — scanner 정규화 + 3분류 (doc-add / doc-expand / code-remove)" | conductor  # 1차 분류. 코드 삭제는 team1 세션 집행 | - | - |
...
| `docs/4. Operations/Conductor_Backlog/SG-009-tablefsm-case-serialization.md` | "Spec Drift: TableFSM / SeatFSM display label vs serialized value case" | conductor  # decision_owner (공통 계약) | - | - |
...
| `docs/4. Operations/Conductor_Backlog/SG-011-rfid-hal-stream-divergence.md` | "Spec Drift: RFID_HAL_Interface §2.1 single-stream vs code 6-stream" | team4  # decision_owner (publisher) | - | - |
...
| `docs/4. Operations/Conductor_Backlog/SG-018-5nf-metamodel-tables.md` | "5NF 메타모델 테이블 부재 (nav_sections / nav_items / report_templates / 외 6종)" | team2  # decision_owner (DB) | - | - |
...
| `docs/4. Operations/Conductor_Backlog/SG-020-websocket-ack-reject-events.md` | "WebSocket Ack/Reject 6 이벤트 신규 D2 (publisher 미동기화)" | team2  # publisher = team2 (websocket/publishers.py) | - | - |
| `docs/4. Operations/Conductor_Backlog/SG-021-rive-embedded-metadata-schema.md` | "Rive 내장 메타데이터 스키마 (B-209 후속, .gfskin SUPERSEDED 대체)" | conductor  # decision_owner (Foundation §5.3) | - | - |
...
| `docs/4. Operations/Conductor_Backlog/_template_implementation.md` | "구현: <기능명>" | conductor  # 또는 해당 팀 | - | - |
| `docs/4. Operations/Conductor_Backlog/_template_prototype_scenario.md` | "시나리오: <검증 대상 통합 흐름>" | conductor  # 시나리오 집행 책임자 | - | - |
| `docs/4. Operations/Conductor_Backlog/_template_spec_gap.md` | "기획 공백: <구체적 공백명>" | conductor  # decision_owner | - | - |
...
| `docs/4. Operations/handoffs/CI_CHAOS_TEST_HANDOFF.md` | CI Chaos Test Handoff (PR #20 gate validation) | conductor | internal | - |
| `docs/4. Operations/handoffs/CI_GATE_INTEGRATION_HANDOFF.md` | CI Gate Integration + ebs_v2 Cleanup Handoff | conductor | internal | - |
| `docs/4. Operations/handoffs/INFRA_ALIGNMENT_HANDOFF.md` | INFRA Alignment Handoff (Conductor Claim #14/#16) | conductor | internal | - |
