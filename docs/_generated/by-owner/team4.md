...
- `docs/2. Development/2.4 Command Center/Command_Center_UI/Multi_Table_Operations.md` — Multi Table Operations
- `docs/2. Development/2.4 Command Center/Command_Center_UI/Overview.md` — Overview
- `docs/2. Development/2.4 Command Center/Command_Center_UI/Player_Edit_Modal.md` — Player Edit Modal
- `docs/2. Development/2.4 Command Center/Command_Center_UI/Seat_Management.md` — Seat Management
...
- `docs/2. Development/2.4 Command Center/Overlay/Security_Delay.md` — Security Delay
- `docs/2. Development/2.4 Command Center/Overlay/Sequences.md` — Sequences
- `docs/2. Development/2.4 Command Center/Overlay/Skin_Loading.md` — Skin Loading
- `docs/2. Development/2.4 Command Center/RFID_Cards/Card_Detection.md` — Card Detection
- `docs/2. Development/2.4 Command Center/RFID_Cards/Deck_Registration.md` — Deck Registration
...
- `docs/_archive/orphan/B-210-overlay-rive-outputevent-mapping.md` — B-210 — Overlay Rive 21 OutputEvent 매핑 sprint
- `docs/_archive/orphan/B-218-cc-auth-prefix-and-engine-host.md` — B-218 — CC Connect 후 2개 버그 (auth prefix + engine host)
- `docs/_archive/orphan/IMPL-002-team4-engine-connection-ui.md` — 구현: team4 Engine Connection UI — router guard + manual reconnect
- `docs/_archive/orphan/IMPL-007-cc-no-card-display-contract.md` — 구현: CC 카드 비노출 계약 강화 (회의 D7 후속)
- `docs/_archive/orphan/SG-011-rfid-hal-stream-divergence.md` — Spec Drift: RFID_HAL_Interface §2.1 single-stream vs code 6-stream
