...
| 날짜 | 항목 | 내용 |
|------|------|------|
| 2026-05-08 | Foundation 자체 정합 + Issue #156 (PR I, #158) | Foundation 본문 "8 액션" 잔재 4곳 정정 → "6 키 (N·F·C·B·A·M)". Foundation Changelog v4.5.0 entry 추가 + Scene 개수 정정. Lobby "8 버튼 액션" + Fixed 6h 정정. BO_PRD outdated 절번호 일괄 정정 (§Ch.4.2 → Ch.4 Scene 1 / §Ch.6.X → Ch.5 §B.X / §Ch.8.5 → Ch.6 Scene 4 / §Ch.1.4 → Ch.1 Scene 4 / §6.4 NFR → Foundation §Ch.5 §B.4) + version 1.0.1→1.1.0 통일. RIVE Ch.2 "8 vs 11 차이" 박스. Product_SSOT_Policy last-updated 추가. Issue #156 closed (16건 중 12건 ✓, 4건 = 1. Product.md CI generated 자동 갱신). |
...
| 2026-05-08 | Cascade 정합 완성 (PR G) | Lobby related-docs 에 Foundation.md 추가 (cascade 시뮬 누락 정정). 3 PRD 모두 frontmatter 에 `last-synced: 2026-04-15` 추가 (정본 ref, 역방향 drift 정직 표기). `.github/workflows/product_cascade.yml` 신규 — Product 변경 PR 시 cascade impact advisory 출력 + 정본 변경 시 derivative PRD 동시 갱신 권고. |
