...
| 날짜 | 항목 | 내용 |
|------|------|------|
| 2026-05-08 | Product 100% 정합 (PR H) | Foundation v4.4 → v4.5 (D2 Hole Card Visibility 4단 방어 + D3 Lobby 4 진입 시점 + D5 Mixed Game HORSE/8-Game 흡수). 3 PRD last-synced 갱신 (D1). Lobby/BO PRD rive-role 명시 (D7). Flop_Games "Foundation Ch 참조" 제거 (D4). Draw.md Pre-Draw/Post-Draw 라벨 (D6). References frontmatter referenced-by (D8). archive frontmatter archived: true + superseded-by (D9). 정합도 95% → **100%**. |
