...
> **① 원본 캡처**:
>
> ![Main Window - 원본 캡처](../../00-reference/images/pokerGFX/스크린샷%202026-02-05%20180630.png)
>
...
> **① 원본 캡처**:
>
> ![Sources 탭 - 원본 캡처](../../00-reference/images/pokerGFX/스크린샷%202026-02-05%20180637.png)
>
> **② 분석 오버레이** *(번호 = annotation 박스 라벨, 빨간 X = Drop)*:
>
> ![Sources 탭 - 분석 오버레이](../../00-reference/images/overlays/gfx_sources2.jpg)
>
> 원본 기능 테이블: [PokerGFX-UI-Analysis.md](PokerGFX-UI-Analysis.md) 참조
...
> **① 원본 캡처**:
>
> ![Outputs 탭 - 원본 캡처](../../00-reference/images/pokerGFX/스크린샷%202026-02-05%20180645.png)
>
> **② 분석 오버레이** *(번호 = annotation 박스 라벨, 빨간 X = Drop)*:
>
> ![Outputs 탭 - 분석 오버레이](../../00-reference/images/overlays/gfx_outputs2.jpg)
>
> 원본 기능 테이블: [PokerGFX-UI-Analysis.md](PokerGFX-UI-Analysis.md) 참조
...
> **① 원본 캡처**:
>
> ![GFX 1 탭 - 원본 캡처](../../00-reference/images/pokerGFX/스크린샷%202026-02-05%20180649.png)
>
> **② 분석 오버레이** *(번호 = annotation 박스 라벨, 빨간 X = Drop)*:
>
> ![GFX 1 탭 - 분석 오버레이](../../00-reference/images/overlays/gfx_gfx1_2.jpg)
...
> **① 원본 캡처**:
>
> ![GFX 2 탭 - 원본 캡처](../../00-reference/images/pokerGFX/스크린샷%202026-02-05%20180652.png)
>
> **② 분석 오버레이** *(번호 = annotation 박스 라벨, 빨간 X = Drop)*:
>
> ![GFX 2 탭 - 분석 오버레이](../../00-reference/images/overlays/gfx_gfx2_2.jpg)
...
> **① 원본 캡처**:
>
> ![GFX 3 탭 - 원본 캡처](../../00-reference/images/pokerGFX/스크린샷%202026-02-05%20180655.png)
>
> **② 분석 오버레이** *(번호 = annotation 박스 라벨, 빨간 X = Drop)*:
>
> ![GFX 3 탭 - 분석 오버레이](../../00-reference/images/overlays/gfx_gfx3_2.jpg)
...
> **① 원본 캡처**:
>
> ![System 탭 - 원본 캡처](../../00-reference/images/pokerGFX/스크린샷%202026-02-05%20180624.png)
>
> **② 분석 오버레이** *(번호 = annotation 박스 라벨, 빨간 X = Drop)*:
>
> ![System 탭 - 분석 오버레이](../../00-reference/images/overlays/gfx_system1.jpg)
