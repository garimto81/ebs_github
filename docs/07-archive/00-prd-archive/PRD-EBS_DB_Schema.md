> **⚠ 이 문서는 archive 상태입니다.** 현행 DB 스키마는 `docs/05-data/DATA-04-db-schema.md`로 승격되었습니다 (2026-04-08). 이 파일은 역사적 참조용으로 보존합니다.
>
> 관련 현행 문서:
> - ER 다이어그램: `docs/05-data/DATA-01-er-diagram.md`
> - 엔티티 정의: `docs/05-data/DATA-02-entities.md`
> - FSM 다이어그램: `docs/05-data/DATA-03-state-machines.md`
> - DB 스키마: `docs/05-data/DATA-04-db-schema.md`
...
| **작성자** | 기획팀 |
| **대상 독자** | 기획팀, 개발팀 |
| **상태** | ~~초안~~ → **Archive** (2026-04-08 `docs/05-data/`로 승격) |
