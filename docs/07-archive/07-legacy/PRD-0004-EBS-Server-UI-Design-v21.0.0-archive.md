...
![Main Window - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/01-main-window.png)
...
![Main Window - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-main.png)

**B. 고정 720×480 (SD 변형)** — `flex:0 0 720px` · SD 480p 출력 환경 전용

![Main Window - EBS 설계본 (720×480 SD 변형)](../01-pokergfx-analysis/mockups/ebs-main-window-720x480-capture.png)
...
![System 탭 - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/08-system-tab.png)
...
![System Tab - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-system.png)
...
![Sources 탭 - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/02-sources-tab.png)
...
![Sources Tab - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-sources.png)
...
![Outputs 탭 - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/03-outputs-tab.png)
...
![Outputs Tab - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-outputs.png)
...
![GFX 1 탭 - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/04-gfx1-tab.png)
...
![GFX 1 Layout - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-gfx-layout.png)

![GFX 1 Visual - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-gfx-visual.png)
...
![GFX 2 탭 - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/05-gfx2-tab.png)
...
![GFX 2 Display - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-gfx-display.png)
...
![GFX 3 탭 - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/06-gfx3-tab.png)
...
![GFX 3 Numbers - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-gfx-numbers.png)
...
![Skin Editor - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/09-skin-editor.png)
...
![Skin Editor - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-skin-editor.png)
...
![Graphic Editor Board - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/10-graphic-editor-board.png)
...
![Graphic Editor Player - PokerGFX 원본](../01-pokergfx-analysis/02_Annotated_ngd/11-graphic-editor-player.png)

##### EBS 설계본

![Graphic Editor - EBS 설계본](../01-pokergfx-analysis/images/mockups/ebs-graphic-editor.png)
...
![Commentary Tab](../01-pokergfx-analysis/02_Annotated_ngd/07-commentary-tab.png)
