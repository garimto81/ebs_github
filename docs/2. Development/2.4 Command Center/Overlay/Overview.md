...
> **상세 (CCR-035)**: Layer 1 8종의 자동화 정도(완전 자동 vs 반자동), Layer 2 데이터 제공 API, 신규 요구사항 Layer 분류 기준은 `Layer_Boundary.md` (legacy-id: BS-07-06) 참조.
...
| 문서 | 관계 |
|------|------|
| `Elements.md` (legacy-id: BS-07-01) | 오버레이 요소 상세 |
