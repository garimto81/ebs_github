...
| 2026-05-07 | v4 cascade | CC_PRD v4.0 정체성 정합 — **8 키 (N·D·F·C·B·R·A) → 6 키 (N·F·C·B·A·M)** 통합. D 키 폐기 (createSession auto), R 키 → B 키 통합 (BET/RAISE auto-switch), M 키 신설 (Menu/Manual/Miss Deal). §"v4.0 6 키 단축키 표준" 신설. SSOT: `docs/1. Product/Command_Center.md` v4.0 §Ch.5. |
...
> **트리거**: `docs/1. Product/Command_Center.md` v4.0 cascade. 8 키 (N·D·F·C·B·R·A) 시대가 끝나고 **6 키 (N·F·C·B·A·M) + Ctrl+Z (UNDO)** 시대가 시작된다.
