...
> 참조: 각 버튼 상세 명세는 `Action_Buttons.md` (legacy-id: BS-05-02)
...
> 참조: HandFSM 상세 전이는 `Holdem/Lifecycle.md` (legacy-id: BS-06-01)
...
| `Triggers.md` (legacy-id: `Triggers.md` (legacy-id: `Triggers.md` (legacy-id: BS-06-00-triggers))) | CC 이벤트 21종 정의 |
| `Holdem/Lifecycle.md` (legacy-id: BS-06-01) | HandFSM 상태 전이 |
...
| AT-04 | Statistics | — | M-01 Toolbar → Menu → Statistics | `Statistics.md` (legacy-id: BS-05-07) |
| AT-05 | RFID Register | — | Settings 또는 메뉴 | `Register_Screen.md` (legacy-id: BS-04-05) |
| AT-06 | Table Settings (Rules 탭) | 600×auto (모달) | M-01 Toolbar `[⚙]` 버튼 → Table Settings → Rules 탭 | `Settings.md §Rules`, `BS-05-08` |
| AT-07 | Player Edit | 모달 | 좌석 요소 탭(인라인 편집) 또는 롱프레스 컨텍스트 메뉴 | `Player_Edit_Modal.md` (legacy-id: BS-05-09) |
...
`POST /api/v1/tables/{id}/launch` 상세는 `Backend_HTTP.md` (legacy-id: API-01) 참조.
