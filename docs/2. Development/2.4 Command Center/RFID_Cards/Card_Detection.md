...
> **참조**: 트리거 경계는 `BS-06-00-triggers.md §3`, DeckFSM 상태는 `Deck_Registration.md` (legacy-id: BS-04-01), 수동 입력은 `Manual_Fallback.md` (legacy-id: BS-04-03), v4.0 정체성은 `Command_Center_UI/Overview.md §3.0`.
