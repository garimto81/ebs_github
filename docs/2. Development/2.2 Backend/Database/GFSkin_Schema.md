...
실패 시 에러 응답 형식: `API-07-graphic-editor.md §1 Upload` 참조.
...
| 구현체 | 접근 방식 |
|--------|----------|
| Team 1 Quasar (클라이언트) | `@ebs/schemas/gfskin-1.0.json` import (monorepo symlink 또는 npm workspace) |
...
| `API-07-graphic-editor.md` | 8 엔드포인트 |
| `CCR-012` | 본 문서 신설 근거 |
