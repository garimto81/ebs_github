...
### Foundation Ch.5 §B.4 정합 — DB = SSOT 원칙 (2026-04-22 신설, 2026-05-08 cascade 정합)

Foundation Ch.5 §B.4 "실시간 동기화 — DB SSOT + WS push" 에 따라 본 DB 스키마는 **EBS 상태의 단일 SSOT** 다. 실무 원칙:
