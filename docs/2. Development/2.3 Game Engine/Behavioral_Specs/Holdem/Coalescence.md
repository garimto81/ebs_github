...
# [DEPRECATED 2026-04-28] BS-06-04: Coalescence
...
| 원본 | → 통합 위치 |
|------|------------|
| BS-06-04 (Coalescence) | Triggers & Event Pipeline 도메인 마스터 §부록 A |
...
```bash
git log --all --follow -- "docs/2. Development/2.3 Game Engine/Behavioral_Specs/Holdem/Coalescence.md"
git show <commit-hash>:"docs/2. Development/2.3 Game Engine/Behavioral_Specs/Holdem/Coalescence.md"
```
