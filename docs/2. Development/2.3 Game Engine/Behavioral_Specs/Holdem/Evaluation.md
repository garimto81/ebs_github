...
| 2026-04-13 | GAP-D 보강 | 핸드 평가 입/출 예시 5건 추가 (Short Deck Wheel 주의사항 포함) |
...
| 4 | A♠ 9♠ | 6♥ 7♣ 8♦ K♠ Q♣ | A♠ K♠ Q♣ 9♠ 8♦ | High Card | A (❌ A-6-7-8-9는 Standard에서 Straight 아님) |
| 5 | 5♠ 5♥ | 5♦ 5♣ A♠ K♥ Q♦ | 5♠ 5♥ 5♦ 5♣ A♠ | Four of a Kind | 5, A |

> 예시 4는 Short Deck(6+)에서만 A-6-7-8-9가 Straight(Wheel)로 인정됨. Standard Hold'em에서는 High Card.
