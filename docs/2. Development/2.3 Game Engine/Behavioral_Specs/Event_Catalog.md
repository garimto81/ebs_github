...
# [DEPRECATED 2026-04-28] BS-06-09: Event Catalog
...
| 원본 | → 통합 위치 |
|------|------------|
| BS-06-09 (Event Catalog) | Triggers & Event Pipeline 도메인 마스터 §부록 A |
...
```bash
git log --all --follow -- "docs/2. Development/2.3 Game Engine/Behavioral_Specs/Event_Catalog.md"
git show <commit-hash>:"docs/2. Development/2.3 Game Engine/Behavioral_Specs/Event_Catalog.md"
```
