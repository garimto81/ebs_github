...
| [B-331 ✅ DONE](Backlog/B-331-harness-engine-health-endpoint.md) | harness `/engine/health` endpoint — 코드+문서+테스트 모두 ready (cycle 2 검증 발견 2026-05-11) | P0 | §B.3 (Demo Mode fallback) |
