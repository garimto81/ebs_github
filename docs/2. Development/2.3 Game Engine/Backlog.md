...
| [NOTIFY-team3 (B-331)](Backlog/NOTIFY-team3-B331-engine-health-code-impl-2026-05-11.md) | B-331 `/engine/health` 코드 구현 필요 — 문서는 S8 완료, 코드는 team3-engine scope | P0 | S8 자율 사이클에서 scope 외 작업 분리 (2026-05-11) |
...
|----|-------|:--------:|----------------|
| [B-330 ✅ DONE](Backlog/B-330-Foundation-Engine-별도-프로세스-전파.md) | Engine 별도 프로세스 원칙 API-04 전반 전파 (S8 2026-05-11) | P0 | §B.2, §B.3 |
| [B-331 ⚠️ NOTIFY-team3](Backlog/B-331-harness-engine-health-endpoint.md) | harness `/engine/health` endpoint — 문서 ✅ (Harness §2.13 + §1 등재), 코드 미구현 (team3 scope) | P0 | §B.3 (Demo Mode fallback) |
| [B-332 ✅ DONE](Backlog/B-332-Engine-응답-게임상태-SSOT-명시.md) | Engine 응답 = 게임 상태 SSOT 명시 (S8 2026-05-11) | P0 | §B.3, §B.4 |
