...
blocked-by: "PR #19 (legacy-id-redirect.json 신규 생성, OPEN 상태)"
related-prs:
  - "PR #19 (Deprecation shim + legacy-id-redirect.json 신규)"
  - "PR (B-351/352/353 — output_event.dart + Triggers §3.4 재정렬, 본 PR)"
---
