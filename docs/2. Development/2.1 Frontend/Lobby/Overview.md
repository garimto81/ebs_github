...
| **Hand History** (화면 6) | EBS 고유 — Hand Browser / Detail / Player Stats 3 서브메뉴, 당일 한정. BO REST `GET /api/v1/hands` 연동 (Cycle 21, `Players_HandHistory_API.md`) | Lobby 사이드바 `■ Hand History` (`Hand_History.md` SSOT) | `visual/screenshots/ebs-lobby-06-hands.png` |
