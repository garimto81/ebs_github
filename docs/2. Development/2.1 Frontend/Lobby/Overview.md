...
> **참조**: Mock HAL 상세 → `../../../contracts/api/API-03-rfid-hal-interface.md`, 덱 등록 행동 명세 → `../../../team4-cc/specs/BS-04-rfid/BS-04-01-deck-registration.md` (BS-04 는 team4 소유)
...
| Game Type | Select | O | NL Hold'em | 22종 게임 (`../../../contracts/specs/BS-06-game-engine/BS-06-00-triggers.md` enum) |
