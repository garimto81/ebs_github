...
> **상위 문서**: [EBS PRD v29.3.0](../pokergfx-prd-v2.md) | **문서 ID**: PRD-0005
> **Google Docs**: (동기화 예정)
...
| 관계 | 문서 | 설명 |
|------|------|------|
| **상위** | [EBS PRD v29.3.0](../pokergfx-prd-v2.md) | 부록 B 요구사항 ID (SK-001~SK-016, GEB-001~GEB-015, GEP-001~GEP-015) |
