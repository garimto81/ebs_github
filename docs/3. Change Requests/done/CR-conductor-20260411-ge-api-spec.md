...
- **제안일**: 2026-04-11
- **영향팀**: [team1, team2]
- **변경 대상 파일**: contracts/api/API-07-graphic-editor.md (add)
- **변경 유형**: add
...
`API-07-graphic-editor.md` 신설, 8개 엔드포인트 정의:
...
`API-07-graphic-editor.md` 신설 (핵심 골격):
...
- API-06-auth-session.md — JWT + RBAC
