...
legacy-id: CCR-DRAFT-team4-20260410-bs05-at-screens
---
...
- `Triggers.md` (legacy-id: `Triggers.md` (legacy-id: `Triggers.md` (legacy-id: BS-06-00-triggers))) §게임 전환 트리거
```
...
- `Backend_HTTP.md` (legacy-id: API-01) §PATCH /players/{id}
- `WebSocket_Events.md` (legacy-id: API-05) §PlayerUpdated, SeatStatusUpdated
```
