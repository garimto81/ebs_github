---
title: EBS 기초 기획서 (Graphic Novel Edition)
owner: conductor
tier: internal
status: DRAFT — Phase 2 complete (Ch.1~6 all chapters)
based-on: Foundation.md v3.1.0
last-updated: 2026-05-07
version: 4.0.0-draft
format: graphic-novel-edition
chapter-completed: [Ch.1, Ch.2, Ch.3, Ch.4, Ch.5, Ch.6]
---
...
> *기능 ≠ 설치 단위. 6 기능은 4 개의 SW 와 1 개의 HW 에 분산된다.*
