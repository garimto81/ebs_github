...
<img src="visual/screenshots/st-v01-seven-card-layout.png" alt="Seven Card Games 카드 7장 — 비공개 3장 + 공개 4장" width="600">
...
<img src="visual/screenshots/st-br-ante.png" alt="Ante — 6인 전원 0.50씩 → 팟 3.00 적립" width="600">
...
<img src="visual/screenshots/st-01-3rd-street.png" alt="3rd Street — Player A(6♠), B(J♥), C(3♣)" width="600">
...
<img src="visual/screenshots/st-br-bringin.png" alt="Bring-in — 가장 낮은 Door Card가 먼저" width="600">
...
<img src="visual/screenshots/st-br-complete.png" alt="Complete — $1 반쪽을 $2 정식으로 채우기" width="600">
...
<img src="visual/screenshots/st-br-escalation.png" alt="Bring-in→Complete→Raise 에스컬레이션 흐름" width="600">
...
<img src="visual/screenshots/st-br-cap.png" alt="Cap — 4회 제한" width="600">
...
<img src="visual/screenshots/st-s4-4th-street.png" alt="4th Street — B의 J 페어" width="600">

> 아직 베팅 단위는 **$2**. B가 Bet $2, A와 C가 Call.

**Open Pair 특수 규칙**: 4th Street에서 **공개 카드에 페어가 보이면**, $2 대신 **$4**로 베팅할 수 있습니다 (선택, 강제 아님).

<img src="visual/screenshots/st-br-open-pair.png" alt="Open Pair — 페어 공개 시 $4 선택 가능" width="600">
...
<img src="visual/screenshots/st-s4-5th-street.png" alt="5th Street — K 페어 등장, Big Bet $4" width="600">
...
<img src="visual/screenshots/st-s4-6th-street.png" alt="6th Street — C Fold, A vs B 1:1" width="600">
...
<img src="visual/screenshots/st-s4-7th-street.png" alt="7th Street — 마지막 비공개 카드, 쇼다운" width="600">

**전체 흐름 정리:**

```mermaid
flowchart LR
    A["3rd Street<br/>비공개2+공개1"] --> B["4th Street<br/>+공개 1장"]
    B --> C["5th~6th<br/>+공개 각1장"]
    C --> D["7th Street<br/>+비공개 1장"]
    D --> E["쇼다운"]
```
...
<img src="visual/screenshots/st-v11-showdown.png" alt="쇼다운 — A One Pair vs B Trips, B 승리" width="600">
...
<img src="visual/screenshots/st-v03-hand-basic.png" alt="High Card, One Pair, Two Pair" width="600">

**중간 4개 — 희귀할수록 강합니다**

<img src="visual/screenshots/st-v04-hand-mid.png" alt="Three of a Kind, Straight, Flush, Full House" width="600">

**희귀 3개 — 전설의 패** (프로 선수도 평생 몇 번 보기 어렵습니다)

<img src="visual/screenshots/st-v05-hand-rare.png" alt="Four of a Kind, Straight Flush, Royal Flush" width="600">
...
<img src="visual/screenshots/bt-01-actions.png" alt="6가지 액션" width="600">
...
<img src="visual/screenshots/st-br-action-order.png" alt="3rd: 약한 패 먼저, 4th+: 강한 패 먼저" width="600">
...
<img src="visual/screenshots/st-v12-hilo-pot-split.png" alt="Hi-Lo 팟 분할 — 50% High + 50% Low" width="600">
...
<img src="visual/screenshots/st-v13-hilo-dual-select.png" alt="같은 7장에서 High 5장과 Low 5장을 따로 선택" width="600">
...
<img src="visual/screenshots/st-v06-low-qualify.png" alt="Low 자격 판정 — 자격 있음(모두 8 이하) vs 자격 없음(9가 8 초과)" width="600">
...
<img src="visual/screenshots/st-v07-hilo-example.png" alt="Stud Hi-Lo 실전 — Player B Trips로 High 승리, 양쪽 모두 Low 불가" width="600">
...
```mermaid
flowchart LR
    A["3rd Street<br/>비공개2+공개1"] --> B["4th~6th<br/>+공개 각1장"]
    B --> C["7th Street<br/>+비공개 1장"]
    C --> D["쇼다운<br/>Hi-Lo 분할!"]
```
...
<img src="visual/screenshots/st-v08-razz-compare.png" alt="같은 카드 — 7-Card Stud에서 최강 Trips가 Razz에서는 최약, Straight가 최강 Wheel" width="600">
...
<img src="visual/screenshots/st-v09-bringin-compare.png" alt="Bring-in 비교 — Stud는 낮은 카드(3♣), Razz는 높은 카드(K♠)" width="600">

### 실전 예시 — Low 비교 방법

Razz에서 승부는 "**가장 높은 카드부터 비교**"합니다. 낮은 쪽이 승리!

<img src="visual/screenshots/st-v10-razz-example.png" alt="Razz 실전 — A의 7-5 Low vs B의 8-6 Low, A 승리" width="600">
