...
| 날짜 | 항목 | 내용 |
|------|------|------|
| 2026-03-30 | 신규 작성 | 12종 Flop Games 규칙 가이드 초판 v1.0.0 |

> **Version**: 1.0.0
> **Date**: 2026-03-30
> **대상 독자**: Part I: 포커를 모르는 사람 누구나 / Part II: 소프트웨어 개발팀
> **시스템 사양**: EBS Foundation PRD §6-8에 정의된 게임 엔진, 오버레이, API 계층 구조를 따릅니다.
...
| 섹션 | 게임 | 커버 종목 |
|:----:|------|:--------:|
| §0 | **기초** — 카드 덱, 비공개/공유 카드, 핸드 랭킹 | -- |
| §1 | **Texas Hold'em** | #1 (1종) |
| §2 | **Short Deck** — Straight > Trips (6+ Hold'em) | #2 (1종) |
| §3 | **Short Deck** — Trips > Straight (Triton) | #3 (1종) |
| §4 | **Pineapple** | #4 (1종) |
| §5 | **Omaha** (4-card) | #5 (1종) |
| §6 | **Omaha Hi-Lo** — Hi-Lo 분할 규칙 설명 | #6 (1종) |
| §7 | **Five Card / Six Card Omaha** (+ 각각 Hi-Lo) | #7~#10 (**4종**) |
| §8 | **Courchevel** (+ Hi-Lo) | #11~#12 (**2종**) |
...
|:-:|------|----------|:------:|:--:|:----:|:------:|:----:|
| 1 | **Texas Hold'em** | 🏠 기준 게임 | 2장 | 52 | High | -- | §1 |
| 2 | Short Deck (6+) | 🃏 36장 덱 | 2장 | **36** | High* | -- | §2 |
| 3 | Short Deck (Triton) | 🔄 Trips>Straight | 2장 | **36** | High* | -- | §3 |
| 4 | Pineapple | ✋ 3장→1장 버림 | 3→2장 | 52 | High | -- | §4 |
| 5 | **Omaha** | 🔒 홀2+보드3 강제 | **4장** | 52 | High | -- | §5 |
| 6 | Omaha Hi-Lo | ⚖️ Hi-Lo 분할 | 4장 | 52 | High+Low | **50/50** | §6 |
| 7 | Five Card Omaha | 📈 홀카드 5장 | **5장** | 52 | High | -- | §7 |
| 8 | Five Card Omaha Hi-Lo (Big O) | 📈+⚖️ 5장+Hi-Lo | **5장** | 52 | High+Low | **50/50** | §7 |
| 9 | Six Card Omaha | 📈 홀카드 6장 | **6장** | 52 | High | -- | §7 |
| 10 | Six Card Omaha Hi-Lo | 📈+⚖️ 6장+Hi-Lo | **6장** | 52 | High+Low | **50/50** | §7 |
| 11 | Courchevel | 👁️ 보드 1장 선공개 | 5장 | 52 | High | -- | §8 |
| 12 | Courchevel Hi-Lo | 👁️+⚖️ 선공개+Hi-Lo | 5장 | 52 | High+Low | **50/50** | §8 |

> *Short Deck는 핸드 순위가 변경됩니다 (상세는 각 게임 섹션 참조)
> Hi-Lo 변형(#8, #10, #12)은 기본 게임과 동일하되 팟 50/50 분할이 추가됩니다 → §6 참조
...
> 베팅 구조 상세 — No Limit(베팅 금액 제한 없음), Pot Limit(현재 팟 크기까지 베팅 가능) 등의 베팅 구조와 Ante, Blind 규칙은 별도의 베팅 시스템 상세 가이드에서 다룹니다.

---

### Step 3. 게임이 진행됩니다 (한 단계씩)
...
4장을 받으니 조합이 훨씬 많아서 **더 큰 패가 자주** 나옵니다. Hold'em보다 액션이 화려하죠. **PLO**(Pot Limit Omaha — 팟 크기까지만 베팅할 수 있는 Omaha)는 Hold'em 다음으로 세계에서 가장 인기 있는 포커 게임입니다.
...
| Phase | 게임 |
|:-----:|------|
| **Phase 2** (2026 H2(하반기, 7~12월)) | Texas Hold'em |
| **Phase 3** (2027 H1) | Omaha, Omaha Hi-Lo |
| **Phase 4** (2027 H2) | Short Deck x2, Pineapple, Five/Six Card Omaha x4, Courchevel x2 |

> 베팅 구조(NL/PL/FL), Ante 7종, 특수 규칙(Bomb Pot, Run It Twice 등)의 상세 사양은 별도의 베팅 시스템 상세 가이드에서 다룹니다.

---

> **이 아래는 소프트웨어 개발팀 전용 섹션입니다.** 포커 규칙 이해에는 Part I만으로 충분합니다. 일반 독자는 여기서 멈추셔도 됩니다.

---

# Part II — 상세 개발 설계 로직

> **역설계 소스**: PokerGFX 역설계 문서 §5~§6 기반. PokerGFX의 게임 상태 머신, 핸드 평가 알고리즘, Hi-Lo 분할 로직을 분석하여 EBS 엔진 설계에 반영했습니다.
