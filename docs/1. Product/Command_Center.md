...
Lobby PRD = B&W refined minimal. CC = Broadcast Dark Amber OKLCH. 운영자 진입/운영 컨텍스트 차이 (lobby 진입 vs broadcast 운영석) 에서 정당화 가능하나, 별도 cycle 에서 cross-app cascade audit 진행 예정.
