...
|-----------|-----------|-----------|-----------|--------------|
| **EBS Lobby Web** | 로비 + 세팅 + 그래픽 에디터 | Flutter Web + Dart | **Web (Docker nginx)** 정규 · Desktop 은 개발 디버깅 | 브라우저 멀티 클라이언트 (LAN) |
...
- **팀 분할은 기능 단위** — team1(로비/세팅/GE), team2(BO), team3(게임 엔진), team4(커맨드 센터/오버레이). 팀 수 ≠ 설치 단위 수.
