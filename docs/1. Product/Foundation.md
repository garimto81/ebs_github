...
> 💡 **5-Act = L6 Mental Model** (운영자 인지 추상화). L2 Engine FSM 은 §B.1 + Command_Center.md Ch.6 (10-state + RUN_IT_TWICE + 게임 클래스 분기). L5 Frontend Display 는 PokerGFX AT Stateless Terminal 패턴 차용. Architecture 전체 stack = Ch.4 Scene 3 "7-Layer" 참조.
...
│             + RUN_IT_TWICE 분기 + Draw flag/counter + Stud  │
