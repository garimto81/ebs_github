...
| 2026-05-13 | 1.2.1 | Traceability Matrix 추가 (POL-04, ssot_verify.py 통합). |
...
| **Derivative of** | [](../2.%20Development/2.2%20Backend/Back_Office/Overview.md) (DEV-02) |
| **Downstream Impact** | FastAPI BO service (team2-backend) · 20-entity DB schema · WSOP LIVE Confirm-triggered pull |
| **Validation Status** | Linked to Confluence [3811967073](https://ggnetwork.atlassian.net/wiki/spaces/WSOPLive/pages/3811967073) ·  |
| **검증 명령** | === EBS SSOT Verification ===
Timestamp: 2026-05-13 22:07:28
Docs Root: C:\claude\ebs\docs

[1] derivative-of Chain Verification
--------------------------------------------------------------------------------
File                                   | derivative-of                                      | Status      
1. Product/Back_Office.md              | ...Development/2.2 Backend/Back_Office/Overview.md | EXISTS      
1. Product/Command_Center.md           | ....4 Command Center/Command_Center_UI/Overview.md | EXISTS      
1. Product/Lobby.md                    | ../2. Development/2.1 Frontend/Lobby/Overview.md   | EXISTS      
...e Engine/Rules/Equity_Calculator.md | ../../1. Product/Game_Rules/Betting_System.md      | MISSING     
...Game Engine/Rules/Multi_Hand_v03.md | ./Multi_Hand_State.md                              | EXISTS      

[2] Confluence page-id Verification (docs/1. Product/)
--------------------------------------------------------------------------------
File                                   | confluence-page-id   | Status    
1. Product/Foundation.md               | 3625189547           | OK        
1. Product/Lobby.md                    | 3811672228           | OK        
1. Product/Command_Center.md           | 3811901603           | OK        
1. Product/Back_Office.md              | 3811967073           | OK        
1. Product/RIVE_Standards.md           | 3816784235           | OK        
1. Product/Product_SSOT_Policy.md      | 3818848697           | OK        
1. Product/Game_Rules/Flop_Games.md    | 3811443642           | OK        
1. Product/Game_Rules/Draw.md          | 3810853753           | OK        
...duct/Game_Rules/Seven_Card_Games.md | 3811771012           | OK        
...roduct/Game_Rules/Betting_System.md | 3811410570           | OK        

[3] llms.txt Coverage Verification
--------------------------------------------------------------------------------
FAIL: docs/llms.txt 파일이 존재하지 않습니다.

=== Summary ===
derivative-of: 4/5 FAIL  |  Confluence ID: 10/10 OK  |  llms.txt: 0/1 FAIL
OVERALL: FAIL |
