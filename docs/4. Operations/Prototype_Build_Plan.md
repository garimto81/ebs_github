...
| 2026-05-08 | v0.3.1-skeleton | autonomous iteration | huge-51mb gitignore 전환, §2 Stream 상태 갱신 (S1/S4 ACTIVE, S2/S3 NOT INIT), §5 fixture/ENV 의존 명세 |
...
| Layer 경계 (CCR-035) | 문서 정합성 review | **S6** — `integration-tests/scenarios/_doc-integrity.sh` 작성 (TODO) |
