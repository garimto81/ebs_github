---
title: Multi-Session Workflow (V10.0 — V9.5 + /iteration skill 격리 도입)
owner: conductor
tier: contract
last-updated: 2026-04-30
governance: v10.0 v9.5_governance_with_iteration_skill_isolation
reimplementability: PASS
reimplementability_checked: 2026-04-30
reimplementability_notes: "V10.0 — V9.5 governance 보존 + /iteration skill 격리 도입 (.claude/skills/iteration/ + 13 iteration- prefix agents + hot-swap curators). 사용자 결정 점 0, 다른 프로젝트 영향 0."
---
...
| 날짜 | 버전 | 핵심 변화 |
|------|------|----------|
| 2026-04-30 | **v10.0** | **`/iteration` skill 격리 도입** — V9.5 governance 보존 + 13 `iteration-` prefix agents + hot-swap curators (#1↔#2 매 phase 자동 교체, swap 직전 1회 검사 + 1회 개선) + dual workflow (Impl-first 7-step / Spec-first 5-step) + 3 KPI (reimplementability ≥ 0.9, drift 단조 감소, runner_halts = 0). IL-1~IL-7 Iron Law self-contained. 사용자 결정 점 0, 다른 프로젝트 영향 0. |
...
- `V9_5_Single_Session_Output_Centric.md` — V9.5 운영 본문
- `V9_4_AI_Centric_Governance.md` — V9.4 (계승)
- `V9_3_Intent_Execution_Boundary.md` — V9.3 (계승)
