...
| API 응답 시간 | p99 < 200ms (BLANK-1 100ms 전체 파이프라인 + endpoint 마진) | ⏳ B-Q12 |
| 에러율 | < 0.1% | ⏳ |
...
| 2.4 Command Center/References/PokerGFX_Reference | conductor | PASS | — | 2026-05-04 SG-030 cascade — 1. Product/References/ → 2.4 Command Center/References/ 이관 |
