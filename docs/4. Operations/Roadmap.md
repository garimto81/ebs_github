...
confluence-page-id: 3834052681
confluence-parent-id: 3184328827
confluence-url: https://ggnetwork.atlassian.net/wiki/spaces/~71202036ff7e0a7684471195434d342e3315ed/pages/3834052681/Roadmap
---
...
## Production Quality Gates (B-Q7 ㉠ 채택, 90% 재정의 2026-04-27)

| 측정 영역 | 기준 (Production-strict) | 상태 (2026-04-27) |
|----------|--------------------------|:-----------------:|
| Test coverage | ~~95%~~ → **90%+** (재정의 2026-04-27) | ✅ team2: **89% / 415 tests (Session 2 final)** |
| Uptime SLA | 99.9% (Phase 1 런칭 기준) | ⏳ B-Q12 측정 |
| API 응답 시간 (운영 메트릭, NFR — 핵심 가치 아님) | p99 < 200ms (전체 파이프라인 + endpoint 마진) | ⏳ B-Q12 |
| 에러율 | < 0.1% | ⏳ |
| 보안 | OWASP Top 10 준수 | ⏳ B-Q11 audit plan |
| 접근성 | WCAG 2.1 AA | ⏳ Session 3 (frontend) |
| i18n | 한글 + 영어 | ⏳ Session 3 |

> **2026-04-27 Coverage 재정의**: 95% → 90%. Session 2 (8 sub-sessions, +154 tests, 78%→89%) 결과로 89% 도달 = **90% 재정의 후 production-strict 충족**. 산업 표준 (일반 80-90%, Google internal 60-80%) 반영. B-Q20 (잔여 6%p) CLOSED. 자세히: `Conductor_Backlog/B-Q7-quality-criteria-production.md`, `SESSION_2_FINAL_REPORT.md`.
