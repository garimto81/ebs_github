...
| 구분 | 기준 | 제목 패턴 | Jira |
|------|------|----------|------|
| **Feature** | 큰 기능 영역 | `[EBS-AI] {Feature}` | Jira에 안 올림 — 문서에서만 그룹핑 |
| **Epic** | Feature 안의 독립된 하위 영역 | `[EBS-AI][{Feature}] {Epic}` | Jira Epic |
| **Story** | Epic 안에서 독립적으로 완료/검증 가능한 단위 | `[EBS-AI][{Feature}][{Epic}] {설명}` | Jira Story |

### 예시

```
Feature: [EBS-AI] 방송 셋업                              ← 문서에서만 관리
  Epic:    [EBS-AI][방송 셋업] 게임 설정                    ← Jira Epic
    Story:   [EBS-AI][방송 셋업][게임 설정] 게임 타입을 선택한다   ← Jira Story
    Story:   [EBS-AI][방송 셋업][게임 설정] RFID 덱을 매핑한다
  Epic:    [EBS-AI][방송 셋업] 플레이어 관리
    Story:   [EBS-AI][방송 셋업][플레이어 관리] 좌석을 배치한다
    Story:   [EBS-AI][방송 셋업][플레이어 관리] 칩을 설정한다
  Epic:    [EBS-AI][방송 셋업] 베팅 설정
    Story:   [EBS-AI][방송 셋업][베팅 설정] 블라인드를 설정한다
    Story:   [EBS-AI][방송 셋업][베팅 설정] Ante 유형을 선택한다
```
