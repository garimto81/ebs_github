...
> 참조: Game Engine 내부 데이터 모델은 `docs/04-rules-games/games/engine-spec/BS-06-00-REF-game-engine-spec.md` Ch.2에 정의되어 있다. 이 문서는 BO 영구 저장 계층을 다룬다.
...
| 참조 | 경로 |
|------|------|
| 엔티티 용어/FSM 정의 | `docs/02-behavioral/BS-00-definitions.md` |
| Game Engine 데이터 모델 | `docs/04-rules-games/games/engine-spec/BS-06-00-REF-game-engine-spec.md` |
| Lobby 엔티티/필드 정의 | `docs/02-behavioral/BS-02-lobby/BS-02-lobby.md` |
| 기존 DB 스키마 초안 | `docs/data/PRD-EBS_DB_Schema.md` |
