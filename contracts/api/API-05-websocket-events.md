...
| 필드 | 타입 | 설명 |
|------|------|------|
| `status` | string | `stopped/running/paused/break/dinner_break` (ClockFSM — BS-00 §3.7) |
| `level` | int | 현재 블라인드 레벨 (1부터) |
| `level_index` | int | 블라인드 구조 배열 인덱스 (Break 포함) |
| `blind_detail_type` | int | `0`=Blind, `1`=Break, `2`=DinnerBreak, `3`=ColorUp, `4`=EndOfDay (BS-00 §3.8) |
