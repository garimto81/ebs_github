...
> **참조**: Mock 모드 정의는 `BS-00-definitions.md §9`, 트리거 합성 규칙은 `BS-06-00-triggers.md §4`, 용어 정의는 `BS-00-definitions.md`
...
> **참조**: RFID 이벤트 카탈로그는 `BS-06-00-triggers.md §2.2`
...
> **주의**: 카드 제거는 "정보"이지 "액션"이 아니다. 폴드는 반드시 운영자 CC 버튼으로만 실행. (BS-06-00-triggers.md §3.2)
...
> **참조**: `BS-06-00-triggers.md §4.3` 시나리오 스크립트
